...
/**
 *   百度坐标系，火星坐标系和WGS84坐标系的相互转换
 * @author wangruihuan
 *
 */
public class GisTransformUtil {
	/**
	 * 定义一些常量
	 */
	 ...
	 * @returns {*[]}
	 */
	public static double[] GCG02toBD09(double gcj_lon, double gcj_lat) {
	 ...
	 * @return
	 */
	public static double[] WGS84toBD09(double wgs_lon, double wgs_lat) {
		// 1、wgs84->gcj
		double[] wgs84_gcj02 = WGS84toGCJ02(wgs_lon, wgs_lat);
		// 2、gcj->bd09
		return GCG02toBD09(wgs84_gcj02[0], wgs84_gcj02[1]);
	}
